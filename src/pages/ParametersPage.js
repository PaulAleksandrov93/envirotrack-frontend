  ...
  let createParameter = async () => {
    if (currentUser) {
      const newParameter = {
        ...
        measurement_instrument: { id: parameter.measurement_instrument.id },
        temperature_celsius: parameter.temperature_celsius,
        humidity_percentage: parameter.humidity_percentage,
        pressure_kpa: parameter.pressure_kpa,
        pressure_mmhg: parameter.pressure_mmhg,
      ...
      <div className='parameter-fields'>
        <div className='parameter-field'>
          ...
          <Select
            ...
            value={parameter && parameter.measurement_instrument ? { value: parameter.measurement_instrument.id, label: parameter.measurement_instrument.name } : null}
            onChange={(selectedOption) =>
              setParameter((prevParameter) => ({ ...prevParameter, measurement_instrument: { id: selectedOption.value, name: selectedOption.label } }))
            }
          />
        </div>
        <div className='parameter-field'>
